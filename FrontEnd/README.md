# Voice Assistant - Savory Bites

A powerful voice-enabled assistant for Savory Bites food ordering application that allows users to navigate, search, filter, and order food using natural voice commands.
...
*Built with ❤️ for Savory Bites - Voice-Based Food Ordering System